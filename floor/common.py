...
class CommonForFloor:
    ...
    @staticmethod
    def get_corners_of_the_surface_with_offset(
        ...
        for _value in corners_of_the_surface:
            new_corners_of_the_surface.append(
                DefNode(
                    _value.coordinate_x + offset_x,
    ...
    def create_first_left_side_with_offset(
        self,
        offset_x: float = 0.0,  # m
        offset_y: float = 0.0,  # m
        offset_z: float = 0.0,
    ...
    def create_window_with_glass(
        self, corners_of_the_opening: List[DefNode]
    ) -> Tuple[DefOpening, DefLoadDistribution]:
    ...
    def copy_and_offset_window_with_glass(
        self,
        ...
        self.all_opening.copy_and_offset(
        ...
        self.all_surfaces.copy_and_offset(
            def_surface=def_load_distribution,
            all_lines=self.all_lines,
            all_nodes=self.all_nodes,
            offset_x=offset_x,
            offset_y=offset_y,
    ...
    def create_back_site_without_door_with_offset(
        self,
        offset_x: float = 0.0,  # m
        offset_y: float = 0.0,  # m
        offset_z: float = 0.0,  # m
    ) -> None:
        corners_of_the_back_surface = [
            DefNode(0, 0, 0),
            DefNode(0, 0, -3.34),
            DefNode(25, 0, -3.34),
            DefNode(25, 0, 0),
        ...
        for _offset_x in [5, 10, 20]:
            self.copy_and_offset_window_with_glass(
                def_opening=window_01,
                def_load_distribution=window_glass_01,
                offset_x=_offset_x,
            )

    def create_back_site_with_offset(
        self,
        offset_x: float = 0.0,  # m
        offset_y: float = 0.0,  # m
        offset_z: float = 0.0,  # m
    ) -> None:
        self.create_back_site_without_door_with_offset(
            offset_x=offset_x, offset_y=offset_y, offset_z=offset_z
        )
        back_window_corners_of_the_opening = [
            DefNode(15.75, 0, -1.23),
            DefNode(15.75, 0, -2.75),
            DefNode(19.25, 0, -2.75),
            DefNode(19.25, 0, -1.23),
        ]
        new_back_window_corners_of_the_opening = (
            self.get_corners_of_the_surface_with_offset(
        ...
        self.create_window_with_glass(
            corners_of_the_opening=new_back_window_corners_of_the_opening
        )

    def create_area_for_stairs_with_offset(
        self,
        offset_x: float = 0.0,  # m
        offset_y: float = 0.0,  # m
        offset_z: float = 0.0,  # m
    ) -> None:
        corners_of_the_left_side = [
            DefNode(15, 11, 0),
            DefNode(15, 11, -3.34),
            DefNode(15, 6.5, -3.34),
            DefNode(15, 6.5, 0),
        ...
        left_side = self.all_surfaces.create_surface_by_nodes(
            corners_of_the_surface=new_corners_of_the_left_side,
            all_nodes=self.all_nodes,
            all_lines=self.all_lines,
            thickness=self.all_thicknesses.uniform_d_300_c20slash25.id,
        )
        self.all_surfaces.copy_and_offset(
            def_surface=left_side,
            all_lines=self.all_lines,
            all_nodes=self.all_nodes,
            offset_x=5 + offset_x,
        )

        corners_of_the_back_side = [
            DefNode(15, 6.5, 0),
            DefNode(20, 6.5, 0),
            DefNode(20, 6.5, -3.34),
            DefNode(15, 6.5, -3.34),
        ...
        self.all_surfaces.create_surface_by_nodes(
            corners_of_the_surface=new_corners_of_the_back_side,
            all_nodes=self.all_nodes,
            all_lines=self.all_lines,
            thickness=self.all_thicknesses.uniform_d_300_c20slash25.id,
        )
        corners_of_the_opening_in_back_side = [
            DefNode(15.75, 6.5, -0.15),
            DefNode(19.25, 6.5, -0.15),
            DefNode(19.25, 6.5, -2.75),
            DefNode(15.75, 6.5, -2.75),
        ]
        new_corners_of_the_opening_in_back_side = (
            self.get_corners_of_the_surface_with_offset(
