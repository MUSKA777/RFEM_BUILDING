...
class SecondFloor(CommonForFloor):
    ...
    def create_bearing_pillars_with_offset(
        self,
        ...
        self.all_members.create_member_by_coordinates(
            ...
            list_sections=[
                AllSections.he_100_A_slash_1_grade_s355,
                AllSections.he_100_A_slash_1_grade_s355,
            ],
            all_nodes=self.all_nodes,
        )
        ...
        bottom_01_line_nodes_coordinates = self.get_corners_of_the_surface_with_offset(
            [DefNode(5, 0, -6.68), DefNode(5, 3.25, -5.93)],
            offset_x,
            offset_y,
            offset_z,
        )
        ...
        bottom_02_line_nodes_coordinates = self.get_corners_of_the_surface_with_offset(
            [DefNode(5, 3.25, -5.93), DefNode(5, 6.5, -6.68)],
            offset_x,
            offset_y,
            offset_z,
        )
        ...
        bottom_03_line_nodes_coordinates = self.get_corners_of_the_surface_with_offset(
            [DefNode(5, 6.5, -6.68), DefNode(5, 8.75, -5.93)],
            offset_x,
            offset_y,
            offset_z,
        )
        ...
        bottom_04_line_nodes_coordinates = self.get_corners_of_the_surface_with_offset(
            [DefNode(5, 8.75, -5.93), DefNode(5, 11, -6.68)],
            offset_x,
            offset_y,
            offset_z,
        )
        ...
        # bottom line 01
        bottom_center_01_nodes_coordinates = (
            self.get_corners_of_the_surface_with_offset(
                [DefNode(5, 3.25, -5.93), DefNode(5, 6.5, -5.93)],
                offset_x,
                offset_y,
                offset_z,
            )
        ...
        # bottom line 02
        bottom_center_02_nodes_coordinates = (
            self.get_corners_of_the_surface_with_offset(
                [DefNode(5, 6.5, -5.93), DefNode(5, 8.75, -5.93)],
                offset_x,
                offset_y,
                offset_z,
            )
        ...
        pillar_01_nodes_coordinates = self.get_corners_of_the_surface_with_offset(
            [DefNode(5, 3.25, -5.93), DefNode(5, 3.25, -6.68)],
            offset_x,
            offset_y,
            offset_z,
        )
        self.all_members.create_member_by_coordinates(
            ...
            list_sections=[
                AllSections.chc_60dot3x3_slash_1_grade_s355,
                AllSections.chc_60dot3x3_slash_1_grade_s355,
            ],
            all_nodes=self.all_nodes,
        )
        ...
        pillar_02_nodes_coordinates = self.get_corners_of_the_surface_with_offset(
            [DefNode(5, 6.5, -5.93), DefNode(5, 6.5, -6.68)],
            offset_x,
            offset_y,
            offset_z,
        )
        ...
        pillar_03_nodes_coordinates = self.get_corners_of_the_surface_with_offset(
            [DefNode(5, 8.75, -5.93), DefNode(5, 8.75, -6.68)],
            offset_x,
            offset_y,
            offset_z,
        )
    ...
    def create_basic_pillars(self) -> None:
        self.all_members.create_member_by_coordinates(
            ...
            list_sections=[
                AllSections.ipe_200_slash_1_grade_s355,
                AllSections.ipe_200_slash_1_grade_s355,
            ],
            all_nodes=self.all_nodes,
        )
