...
class AllMembers:
    ...
    def create_member_by_coordinates(self,
        ...
        for _node in nodes_coordinates:
            ...
            if not node_id:
                new_node = all_nodes.create_node(coordinate_x=_node.coordinate_x,
                                                 coordinate_y=_node.coordinate_y,
                                                 coordinate_z=_node.coordinate_z)
                node_id = new_node.id
            all_nodes_id.append(node_id)
            nodes_def_member.append(DefNode(id=node_id,
                                            coordinate_x=_node.coordinate_x,
                                            coordinate_y=_node.coordinate_y,
                                            coordinate_z=_node.coordinate_z))
        ...
        Member(start_node_no=all_nodes_id[0],
